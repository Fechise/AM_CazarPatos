...
import com.quillupangui.andres.cazarpatos.database.RankingPlayerDBHelper
...
class RankingActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jugadores.add(Player("Andrés.Quillupangui",10))
    ...
    fun consultarPuntajeJugadores() {
        ...
        db.collection("ranking")
            .orderBy("huntedDucks", com.google.firebase.firestore.Query.Direction.DESCENDING)
            .get()
